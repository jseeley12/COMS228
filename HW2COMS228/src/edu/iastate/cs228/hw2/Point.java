...
public class Point implements Comparable<Point>
{
	...
	//you may want to see compareTo() method in Points class when compare points by x or y. Eg, when order = 1, compare by x, but if x1 = x2, you need to compare y instead of saying they are equal
